...
import { stringifyBigInts, toFixedHex } from 'utils/bigInt';
...
export const generateSnarkProof = async (inputs: any, circuit: string = 'transaction2') => {
  //@ts-ignore
...
export const generateSnarkProofSolidity = async (inputs: any, circuit: string = 'transaction2') => {
